...
HD_PWD='C:/Users/danie/Documents/GitHub/regex_coprocessor_safe/proj/regex_copro/regex_copro.runs/re2_copro_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log re2_copro_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source re2_copro_xbar_1.tcl
