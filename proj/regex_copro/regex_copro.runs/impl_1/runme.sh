...
HD_PWD='C:/Users/danie/Documents/GitHub/regex_coprocessor_safe/proj/regex_copro/regex_copro.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log re2_copro_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source re2_copro_wrapper.tcl -notrace
