...
HD_PWD='C:/Users/danie/Documents/GitHub/regex_coprocessor_safe/proj/regex_copro/regex_copro.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log re2_copro_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source re2_copro_wrapper.tcl
