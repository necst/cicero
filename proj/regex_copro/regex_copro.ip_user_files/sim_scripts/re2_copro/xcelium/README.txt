...
#
# Generated by export_simulation on Fri Feb 12 18:37:09 +0100 2021
#
################################################################################
...
'-reset_run' switch to the './re2_copro.sh' script.

./re2_copro.sh -reset_run
...
./re2_copro.sh -noclean_files

For more information on the script, please type './re2_copro.sh -help'.
