...
xvlog_opts="--relax -L axi_vip_v1_1_6 -L zynq_ultra_ps_e_vip_v1_0_6 -L xilinx_vip"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_6 -L zynq_ultra_ps_e_vip_v1_0_6 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot re2_copro xil_defaultlib.re2_copro xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim re2_copro -key {Behavioral:sim_1:Functional:re2_copro} -tclbatch cmd.tcl -protoinst "protoinst_files/re2_copro.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb re2_copro.wdb xsim.dir)
