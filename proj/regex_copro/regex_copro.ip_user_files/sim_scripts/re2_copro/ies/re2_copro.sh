...
execute()
{
  irun $irun_opts \
       ...
       -top xil_defaultlib.re2_copro \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../regex_copro.srcs/sources_1/bd/re2_copro/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../regex_copro.srcs/sources_1/bd/re2_copro/ipshared/0eaf/hdl" \
       +incdir+"../../../../regex_copro.srcs/sources_1/bd/re2_copro/ipshared/ec67/hdl" \
       +incdir+"../../../../regex_copro.srcs/sources_1/bd/re2_copro/ipshared/0eaf/hdl" \
       +incdir+"../../../../regex_copro.srcs/sources_1/bd/re2_copro/ip/re2_copro_zynq_ultra_ps_e_0_0/sim_tlm" \
       +incdir+"../../../../regex_copro.srcs/sources_1/bd/re2_copro/ip/re2_copro_zynq_ultra_ps_e_0_0" \
